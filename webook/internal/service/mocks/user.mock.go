...
func (m *MockUserService) UpdateNoSensitiveInfo(ctx context.Context, user domain.User) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserServiceMockRecorder) UpdateNoSensitiveInfo(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNoSensitiveInfo", reflect.TypeOf((*MockUserService)(nil).UpdateNoSensitiveInfo), ctx, user)
}
