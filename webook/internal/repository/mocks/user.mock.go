...
func (m *MockUserRepository) UpdateNoSensitiveInfo(ctx context.Context, user domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateNoSensitiveInfo", ctx, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateNoSensitiveInfo indicates an expected call of UpdateNoSensitiveInfo.
func (mr *MockUserRepositoryMockRecorder) UpdateNoSensitiveInfo(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNoSensitiveInfo", reflect.TypeOf((*MockUserRepository)(nil).UpdateNoSensitiveInfo), ctx, user)
}
