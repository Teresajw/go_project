...
import (
	...
	dao "github.com/Teresajw/go_project/webook/internal/repository/dao"
...
func (m *MockUserDao) UpdateNoSensitiveInfo(ctx context.Context, id int64, u dao.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateNoSensitiveInfo", ctx, id, u)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateNoSensitiveInfo indicates an expected call of UpdateNoSensitiveInfo.
func (mr *MockUserDaoMockRecorder) UpdateNoSensitiveInfo(ctx, id, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNoSensitiveInfo", reflect.TypeOf((*MockUserDao)(nil).UpdateNoSensitiveInfo), ctx, id, u)
}
